...
| 第 8 层 | 绩效考核管理（政务创建模板/启动考核，载体提交，政务评分）+ 账号注销 | ⬜ |
...
| 重大事项变更 | `/enterprise/changes` | 功能开发中 |
| 政策申报 | `/enterprise/policies` | 功能开发中 |
| 智能辅助申报 | `/enterprise/ai-assist` | 功能开发中 |
...
| 变更审核 | `/carrier/changes` | 功能开发中 |
| 政策申报 | `/carrier/policies` | 功能开发中 |
| 绩效考核 | `/carrier/performances` | 功能开发中 |
...
| 政策管理 | `/gov/policies` | 功能开发中 |
| 申报审核 | `/gov/applications` | 功能开发中 |
| 绩效考核 | `/gov/performances` | 功能开发中 |
